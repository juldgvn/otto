...
return <Body
className={`w-body cawvv4x clbs92w crrl15v`}>
<Box
...
<Box
className={`w-box c5v5kjp c156cxpv c1mqfhhk c1bx6qap c16k25yp c264rh0 c81es7v c161dwoq cedz2mm crrl15v clbs92w cawvv4x`}>
<Image
src={"/assets/supabase-logo_cXpAta6PVvM_dVc0fIADM.svg"}
width={109}
height={113}
className={`w-image c1f8w3i3`} />
<Text
className={`w-text cx9xznx c1f8w3i3 c1j2cyb c1leo1ea crcjlf0 c1t0dtmd cqmghal cake5go c117ekgf`}>
{"Welcome to Webstudio Supabased."}
{""}
<br />
{""}
{""}
<br />
{""}
{"When you clone it won't immediately work since you haven't added any of your config keys. You can find those in your Supabase Project Settings under API."}
{""}
<br />
{""}
{""}
<br />
{""}
{"To activate functionality, go to \"Module\" and remove the quotes around the code."}
</Text>
</Box>
<Slot>
<Fragment_1>
